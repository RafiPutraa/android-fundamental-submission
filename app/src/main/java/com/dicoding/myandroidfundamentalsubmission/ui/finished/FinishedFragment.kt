package com.dicoding.myandroidfundamentalsubmission.ui.finished
...
import com.dicoding.myandroidfundamentalsubmission.databinding.FragmentFinishedBinding
...
class FinishedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        eventAdapter = EventAdapter{ selectedEvent ->
            ...
            findNavController().navigate(R.id.action_navigation_finished_to_navigation_detail, bundle)
        }
